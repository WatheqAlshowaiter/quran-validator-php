...
- [x] add "Not ported" code 
- [x] coverage should be 100%
- [ ] make sure it is equal to the python port
- [ ] make sure it is equal to js port
...
- [ ] make the github actions 2 - one for test, other for formatting
